...
gulp.task("sass", function() {
  return gulp
    .src("app/stylesheets/sass/styles.scss")
    .pipe(sass())
    .pipe(
      autoprefixer({
...
gulp.task("css", function() {
  return gulp.src("app/stylesheets/*.css").pipe(gulp.dest("dist/css/"));
});
...
gulp.task("build", function(callback) {
  runSequence("clean:dist", ["useref", "css", "images", "fonts"], callback);
});
